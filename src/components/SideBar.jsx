...
const Sidebar = () => {
  ...
  const items = [
    { src: Home_icon, alt: "Home" },
    { src: Offer_icon, alt: "Offers" },
    { src: Like_icon, alt: "Likes" },
    { src: Male_icon, alt: "Profile" },
    { src: Notify_icon, alt: "Notifications" },
  ];
...
>
  ...
  />
      ...
      {/* LOGOUT */}
      <button onClick={() => navigate("/home")} className="mt-auto w-12 h-12 flex items-center justify-center rounded-xl hover:bg-white/5">
