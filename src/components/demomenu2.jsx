...
{showReceipt && receiptData && (
  <div className="fixed inset-0 z-[100] bg-black/60 flex items-center justify-center px-4">
    <div className="bg-[#1f1d29] w-full max-w-sm rounded-2xl p-5 text-gray-200">
      ...
      <button
        ...
        className="w-full mt-4 bg-orange-400 py-2 rounded-lg text-black text-sm font-semibold"
      >
        Done
      </button>
    </div>
